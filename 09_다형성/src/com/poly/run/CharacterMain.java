...
public class CharacterMain {
	...
	public static void main(String[] args) {
		...
		case 2 : gc=new GameController(new Wizard(50,1,"이동제",100,
				new String[] {"파이어볼","아이스어택","윈드스톰"})); break;
		case 3 : gc=new GameController(new Archer(50,1,"최인호",20)); break;
