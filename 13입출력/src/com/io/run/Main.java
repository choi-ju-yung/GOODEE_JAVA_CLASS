...
//				new Person("강민기",32,'남',180.5,"경기도 안산시"),
...
//		new SubStreamController().objcetSave();
//		Person p = new SubStreamController().objectLoad();
//		System.out.println(p);
		
//		new SubStreamController().savePersonbject(persons);
//		Person[] result = new SubStreamController().loadPersonObject();
//		for(Person p : result) {
//			System.out.println(p);
//		}
	}
